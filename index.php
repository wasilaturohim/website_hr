...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		<!-- Navbar -->
		<nav class="main-header navbar navbar-expand navbar-white navbar-light-primary elevation-1">
			<!-- Left navbar links -->
			<ul class="navbar-nav">
				<li class="nav-item">
		...
		<aside class="main-sidebar sidebar-light-red elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> HUMAN RESOURCE</span>
			</a>
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://www.telkom.co.id/sites">
					<strong> telkom witel jambi</strong>
				</a>
				All rights reserved.
			</div>
			<b>Created 2023</b>
