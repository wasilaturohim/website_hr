	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="Nama_Karyawan" name="Nama_Karyawan" value="<?php echo $data_cek['Nama_Karyawan']; ?>" readonly />
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="Pendapatan" name="Pendapatan" value="<?php echo $data_cek['pendapatan']; ?>" />
				</div>
			</div>
        ...
        Posisi = ?";
			...
			$bind_types = "ssssssss";  // Adjust the data types accordingly
			...
			if (!empty($sumber)) {
				...
				$sql_ubah .= ", foto = ?";
				$bind_types .= "s";
				$bind_params[] = $nama_file;
			}

			if (!empty($_POST['Pendapatan'])) {
				$sql_ubah .= ", pendapatan = ?";
				$bind_types .= "s";
				$bind_params[] = $_POST['Pendapatan'];
			}

			$sql_ubah .= " WHERE Nama_Karyawan = ?";
			$bind_types .= "s";
			$bind_params[] = $_POST['Nama_Karyawan'];
